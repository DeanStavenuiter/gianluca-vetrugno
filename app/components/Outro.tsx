...
const Outro = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Prep SVG path for "draw" animation
      const path = svgPathRef.current!;
      ...
      // SVG animation (NOT scroll-driven)
      const svgTl = gsap.timeline({ paused: true });
      svgTl
        .to(path, { strokeDashoffset: 0, ease: "none", duration: 2 })
        // Fill immediately after the draw completes (no fade).
        .set(path, { fillOpacity: 1 });
